...
var file_isuxportal_resources_benchmark_result_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x42, 0x81, 0x02, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x73, 0x75, 0x78, 0x70,
	...
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3f, 0x67,
...
func file_isuxportal_resources_benchmark_result_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_isuxportal_resources_benchmark_result_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_isuxportal_resources_benchmark_result_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_isuxportal_resources_benchmark_result_proto_msgTypes[2].Exporter = func(v any, i int) any {
