...
var file_isuxportal_services_contestant_clarifications_proto_rawDesc = []byte{
	...
	0x63, 0x6c, 0x61, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xbe, 0x02,
	...
	0x01, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x69, 0x73,
...
func file_isuxportal_services_contestant_clarifications_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_isuxportal_services_contestant_clarifications_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_contestant_clarifications_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_contestant_clarifications_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_contestant_clarifications_proto_msgTypes[3].Exporter = func(v any, i int) any {
