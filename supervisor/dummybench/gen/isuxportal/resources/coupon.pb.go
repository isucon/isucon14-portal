...
var file_isuxportal_resources_coupon_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x42, 0x89, 0x02, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x73, 0x75, 0x78, 0x70,
...
func file_isuxportal_resources_coupon_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_isuxportal_resources_coupon_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Coupon); i {
			case 0:
				return &v.state
			case 1:
