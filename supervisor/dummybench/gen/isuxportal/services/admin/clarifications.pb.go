...
var file_isuxportal_services_admin_clarifications_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xb1, 0x02, 0x0a, 0x23, 0x63,
...
func file_isuxportal_services_admin_clarifications_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_isuxportal_services_admin_clarifications_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_admin_clarifications_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_admin_clarifications_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_admin_clarifications_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_admin_clarifications_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_admin_clarifications_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_admin_clarifications_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_isuxportal_services_admin_clarifications_proto_msgTypes[7].Exporter = func(v any, i int) any {
